...
$sql = mysqli_query($connect, "SELECT * FROM information WHERE Id = '$_GET[Id]'");
$data = mysqli_fetch_assoc($sql);

if(isset($_POST["ubah_information"])){
    ...
    if($_FILES["gambar"]["error"] == 4){
        ...
        if ( !in_array($imageExtension, $validImageExtension) ){
            ...
            mysqli_query($connect, "UPDATE information SET
                Judul = '$judul',
                Deskripsi = '$deskripsi',
                Gambar = '$newImageName',
                Tanggal = '$data',
                Diunggah_oleh = '$namaLengkap'
                WHERE Id = '$_GET[Id]'
            ");
    ...
    <div class="mx-4 pt-[5.5rem]">
        <div class="mx-auto max-w-md pt-8">
            <div class="bg-white shadow-md rounded-lg px-7 md:px-10 pt-6 pb-8 mb-4">
                <h1 class="text-2xl font-bold mb-6 mt-3 text-center text-dark">UPDATE INFORMASI</h1>
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            ...
                            name="deskripsi"><?php echo nl2br($data['Deskripsi']) ?></textarea>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary"
                            id="date" type="date" name="date" value="<?php echo $data['Tanggal'] ?>">
                    </div>
                    ...
                    <div class="flex items-center justify-between mb-3">
                        <input
                            ...
                            type="submit" value="Ubah" name="ubah_information">
                    </div>
                </form>
            </div>
        </div>
